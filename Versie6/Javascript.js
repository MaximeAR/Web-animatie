...
window.addEventListener('click', varen);
...
var Witte_blok_1_mobiel = document.querySelector('#Witte_blok_1');
console.log(Witte_blok_1_mobiel);

window.addEventListener('click', movemobiel1);

function movemobiel1(){
    Witte_blok_1_mobiel.classList.toggle('links');
}

var Witte_blok_2_mobiel = document.querySelector('#Witte_blok_2');
console.log(Witte_blok_2_mobiel);

window.addEventListener('click', movemobiel2);

function movemobiel2(){
    Witte_blok_2_mobiel.classList.toggle('links');
}

var Witte_blok_3_mobiel = document.querySelector('#Witte_blok_3');
console.log(Witte_blok_3_mobiel);

window.addEventListener('click', movemobiel3);

function movemobiel3(){
    Witte_blok_3_mobiel.classList.toggle('links');
}